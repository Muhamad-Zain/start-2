                ...
                <div className='bg-black bg-opacity-25 w-[90%] p-2  m-auto z-10 relative rounded-3xl'>
                    <div className='bg-black bg-opacity-20 border-double border-4  rounded-3xl m-auto'>
                        {/* <div> */}
                            <AnimateSee>
                                ...
                                <div className='text-center text-white  py-5'>
                                    <h3 className='sacramento text-3xl font-bold'>{data?.name?.namaLengkap?.nameOne}</h3>
                        ...
                        <div className='pb-10'>
                            ...
                            <div className='text-center text-white  py-5'>
                                <h3 className='sacramento text-3xl font-bold'>{data?.name?.namaLengkap?.nameTwo}</h3>
